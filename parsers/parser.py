...
class Parser(object):
    ...
    def validate_args(self):
        if self.parsed_args.command not in ['file_manager', 'network_manager']:
            ...
            if self.parsed_args.action == "replace" and (not self.parsed_args.replace_data or not self.parsed_args.data):
                self.parser.error("Must specify data being replaced and data to replace with.")
